    ...
    if request.method == 'POST':
        ...
        if user:
            ...
            if user.is_active:
                ...
                return HttpResponseRedirect(reverse('login_app:loginindex'))
            else:
...
def profile(request):
    return render(request,'login_app/userprofileinfo.html',{})
  


def loginindex(request):
    return render(request,'login_app/loginindex.html',{})
...
class HomeView(View):
    def get(self, request, *args, **kwargs):
        return render(request, 'login_app/charts.html', {"customers": 10})
